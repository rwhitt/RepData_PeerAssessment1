...
amedian <- median(atot)
```
The mean number of steps per day is **`r amean`** and the median is **`r amedian`**
...
The interval with the gratest number of steps, averaged across all days, occured at minute: **`r amax`**
...
```
There are **`r nummissing`** "NA" values in the dataset
...
The new mean is: **`r fillmean`**, and the new median is: **`r fillmedian`**
